...
LOG_GROUP    = int(os.getenv("LOG_GROUP", "-1004424533648"))
FORCE_SUB    = int(os.getenv("FORCE_SUB", "-1004419031099"))
...
# ─── UI / LINKS ─────────────────────────────────────────────────────────────────
JOIN_LINK     = os.getenv("JOIN_LINK", "https://t.me/JarvisBatches")
ADMIN_CONTACT = os.getenv("ADMIN_CONTACT", "https://t.me/YashKmwt")
